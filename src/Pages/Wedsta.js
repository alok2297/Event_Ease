...
const Wedsta = () => {
  ...
  return (
    <div>
      ...
      <Container children={
        <div>
          <h3 style={{ margin: "50px 0px 0 0px", fontFamily: "sans-serif", color: "#4a4a4a" }}>Our Latest Work</h3>
          <div style={{ margin: "80px 0px 0 0px", boxShadow: "0px 3px 8px rgba(0, 0, 0, 0.24)" }}>
