      ...
      <div className="UpperDiv-CityPop">
        <div className="Search-Div" style={{marginLeft:"20px"}}>
          <div className="search-input-container">
            <svg className="MuiSvgIcon-root icon" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="container">
          <div class="child1">
            <div className="Top-Cities">
               <a className="HeadDing-City" href="#">Top Cities</a>
               <div className="CityName">
               {TopCities.map(item => <a className="CityName" key={item.id} name={item.name}>{item.city}</a>)}
               </div>
            </div>
          </div>
          <div class="child2">
            <div className="Popular-Cities">
               <a className="HeadDing-City" href="#">Popular Cities</a>
               <div className="CityName">
               {PopularCities.map(item => <a className="CityName" key={item.id} name={item.name}>{item.city}</a>)}
               </div>
            </div>
          </div>
          <div class="child3">
            <div className="Other-Cities">
               <a className="HeadDing-City" href="#">Other Cities</a>
               <div className="CityName">
               {OtherCity.map(item => <a className="CityName" key={item.id} name={item.name}>{item.city}</a>)}
               </div>
            </div>
          </div>
          <div class="child4">
            <div className="International-Cities">
               <a className="HeadDing-City" href="#">International Cities</a>
               <div className="CityName">
               {InternationalCity.map(item => <a className="CityName" key={item.id} name={item.name}>{item.city}</a>)}
               </div>
            </div>
          </div>
        </div>
